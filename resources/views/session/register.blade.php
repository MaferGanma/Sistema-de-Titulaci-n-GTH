      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Al Sistema de Control y Seguimiento de Modalidades de Titulación de la 
              Universidad Pública de El Alto.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <p class="text-sm mt-3 mb-0">¿Ya tienes una cuenta?<a href="login" class="text-dark font-weight-bolder"> Iniciar sesión</a></p>
              </form>
            </div>
          </div>
        </div>
