...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('vista_tesis') ? 'active' : '') }} " href="{{ route('vista_tesis') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>customer-support</title>
                    <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Tesis</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('roles') ? 'active' : '') }}" href="{{ route('roles.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <!-- Ícono SVG normal -->
                <svg width="12px" height="12px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="{{ Request::is('roles') ? 'd-none' : '' }}">
                    <title>roles</title>
                    <g fill="none" fill-rule="evenodd">
                        <path fill="#000000" d="M12 14c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.33-8 4v1h16v-1c0-2.67-5.33-4-8-4zm4-6c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm-8 0c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"></path>
                    </g>
                </svg>
                ...
                <svg width="12px" height="12px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="{{ Request::is('roles') ? '' : 'd-none' }}">
                    <title>roles</title>
                    <g fill="none" fill-rule="evenodd">
                        <path fill="#FFFFFF" d="M12 14c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.33-8 4v1h16v-1c0-2.67-5.33-4-8-4zm4-6c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm-8 0c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"></path>
                    </g>
                </svg>
            </div>
    ...
    <li class="nav-item">
        <a class="nav-link {{ (Request::is('permisos') ? 'active' : '') }}" href="{{ route('permisos.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <!-- Ícono SVG para el estado inactivo -->
                <svg width="13px" height="13px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="{{ Request::is('permisos') ? 'd-none' : '' }}">
                    <title>Permissions</title>
                    <g fill="none" fill-rule="evenodd">
                        <path fill="#000000" d="M12 1C9.794 1 8 2.794 8 5V8H4V20H20V8H16V5C16 2.794 14.206 1 12 1ZM6 20V10H18V20H6ZM12 4C13.104 4 14 4.896 14 6V8H10V6C10 4.896 10.896 4 12 4ZM8 8V5C8 3.343 9.343 2 11 2C12.657 2 14 3.343 14 5V8H8Z"></path>
                    </g>
                </svg>

                <!-- Ícono SVG para el estado activo -->
                <svg width="13px" height="13px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="{{ Request::is('permisos') ? '' : 'd-none' }}">
                    <title>Permissions</title>
                    <g fill="none" fill-rule="evenodd">
                        <path fill="#FFFFFF" d="M12 1C9.794 1 8 2.794 8 5V8H4V20H20V8H16V5C16 2.794 14.206 1 12 1ZM6 20V10H18V20H6ZM12 4C13.104 4 14 4.896 14 6V8H10V6C10 4.896 10.896 4 12 4ZM8 8V5C8 3.343 9.343 2 11 2C12.657 2 14 3.343 14 5V8H8Z"></path>
                    </g>
                </svg>
            </div>
      ...
      @endrole
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('cliente') ? 'active' : '') }} " href="{{ route('cliente.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>customer-support</title>
                    <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
